...
TMap<int32, TLBaseObject*> TLObjects()
{
	...
	AllObjects.Add(153267905, new COMMON::InputMediaPhotoExternal());
	...
	AllObjects.Add(8322574, new STORAGE::FileJpeg());
	AllObjects.Add(-891180321, new STORAGE::FileGif());
	AllObjects.Add(172975040, new STORAGE::FilePng());
	...
	AllObjects.Add(164646985, new COMMON::UserStatusEmpty());
	AllObjects.Add(-306628279, new COMMON::UserStatusOnline());
	AllObjects.Add(9203775, new COMMON::UserStatusOffline());
	AllObjects.Add(-496024847, new COMMON::UserStatusRecently());
	AllObjects.Add(129960444, new COMMON::UserStatusLastWeek());
	...
	AllObjects.Add(120753115, new COMMON::ChatForbidden());
	AllObjects.Add(213142300, new COMMON::Channel());
	...
	AllObjects.Add(236446268, new COMMON::PhotoSizeEmpty());
	...
	AllObjects.Add(253890367, new COMMON::UserFull());
	...
	AllObjects.Add(189033187, new MESSAGES::MessagesSlice());
	...
	AllObjects.Add(125178264, new COMMON::UpdateChatParticipants());
	...
	AllObjects.Add(196268545, new COMMON::UpdateStickerSetsOrder());
	...
	AllObjects.Add(239663460, new COMMON::UpdateBotInlineSend());
	...
	AllObjects.Add(16030880, new UPDATES::Difference());
	...
	AllObjects.Add(157948117, new UPLOAD::File());
	AllObjects.Add(-363659686, new UPLOAD::FileCdnRedirect());
	AllObjects.Add(98092748, new COMMON::DcOption());
	...
	AllObjects.Add(218751099, new COMMON::InputPrivacyValueAllowContacts());
	...
	AllObjects.Add(195371015, new COMMON::InputPrivacyValueDisallowContacts());
	...
	AllObjects.Add(209668535, new COMMON::PrivacyValueDisallowUsers());
	...
	AllObjects.Add(250621158, new COMMON::DocumentAttributeVideo());
	...
	AllObjects.Add(90744648, new COMMON::KeyboardButtonSwitchInline());
	...
	AllObjects.Add(0xafeb712e, new COMMON::InputChannel());
	AllObjects.Add(2131196633, new CONTACTS::ResolvedPeer());
	AllObjects.Add(182649427, new COMMON::MessageRange());
	...
	AllObjects.Add(106343499, new COMMON::ChannelParticipantsSearch());
	...
	AllObjects.Add(175419739, new COMMON::BotInlineMessageMediaAuto());
	...
	AllObjects.Add(104314861, new COMMON::TopPeerCategoryCorrespondents());
	...
	AllObjects.Add(82699215, new MESSAGES::FeaturedStickersNotModified());
	AllObjects.Add(-123893531, new MESSAGES::FeaturedStickers());
	AllObjects.Add(186120336, new MESSAGES::RecentStickersNotModified());
	...
	AllObjects.Add(70813275, new COMMON::InputStickeredMediaDocument());
	AllObjects.Add(-1107729093, new COMMON::Game());
	AllObjects.Add(53231223, new COMMON::InputGameID());
	...
	AllObjects.Add(145955919, new COMMON::PageBlockCollage());
	...
	AllObjects.Add(174260510, new AUTH::CheckPassword());
	...
	AllObjects.Add(150761757, new ACCOUNT::GetAccountTTL());
	AllObjects.Add(608323678, new ACCOUNT::SetAccountTTL());
	AllObjects.Add(149257707, new ACCOUNT::SendChangePhoneCode());
	...
	AllObjects.Add(227648840, new USERS::GetUsers());
	...
	AllObjects.Add(60726944, new MESSAGES::Search());
	AllObjects.Add(238054714, new MESSAGES::ReadHistory());
	AllObjects.Add(469850889, new MESSAGES::DeleteHistory());
	AllObjects.Add(-443640366, new MESSAGES::DeleteMessages());
	AllObjects.Add(94983360, new MESSAGES::ReceivedMessages());
	...
	AllObjects.Add(164303470, new MESSAGES::CreateChat());
	...
	AllObjects.Add(258170395, new MESSAGES::GetInlineGameHighScores());
	AllObjects.Add(218777796, new MESSAGES::GetCommonChats());
	...
	AllObjects.Add(163765653, new MESSAGES::SetBotPrecheckoutResults());
	...
	AllObjects.Add(51854712, new UPDATES::GetChannelDifference());
	...
	AllObjects.Add(176122811, new CHANNELS::GetChannels());
	AllObjects.Add(141781513, new CHANNELS::GetFullChannel());
	...
	AllObjects.Add(187583869, new LANGPACK::GetDifference());
